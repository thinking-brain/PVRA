...
-- --------------------------------------------------
-- Date Created: 04/28/2015 18:06:35
-- Generated from EDMX file: D:\Trabajos\Proyectos Programacion\Proyectos C# 2013\PVRA\PVRA\Models\PvraDataModel.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [PvraDataEntities];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_FKCompraMate522193]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CompraMateriales] DROP CONSTRAINT [FK_FKCompraMate522193];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_FKEntradaPro774223]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EntradaProductos] DROP CONSTRAINT [FK_FKEntradaPro774223];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_FKOtrosGasto598550]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OtrosGastos] DROP CONSTRAINT [FK_FKOtrosGasto598550];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_FKProveedor_585764]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Proveedor_Material] DROP CONSTRAINT [FK_FKProveedor_585764];
GO
IF OBJECT_ID(N'[dbo].[FK_FKProveedor_681035]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Proveedor_Material] DROP CONSTRAINT [FK_FKProveedor_681035];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_FKSalidaMate199871]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[SalidaMateriales] DROP CONSTRAINT [FK_FKSalidaMate199871];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_FKUsuario36525]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Usuario] DROP CONSTRAINT [FK_FKUsuario36525];
GO
IF OBJECT_ID(N'[dbo].[FK_FKVentas170181]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Ventas] DROP CONSTRAINT [FK_FKVentas170181];
GO
...
ALTER TABLE [dbo].[Usuario]
ADD CONSTRAINT [FK_FKUsuario36525]
    FOREIGN KEY ([RolId])
    REFERENCES [dbo].[Rol]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_FKUsuario36525'
CREATE INDEX [IX_FK_FKUsuario36525]
ON [dbo].[Usuario]
    ([RolId]);
GO
