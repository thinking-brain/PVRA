...
-- --------------------------------------------------
-- Date Created: 05/23/2015 21:53:19
-- Generated from EDMX file: D:\Trabajos\Proyectos Programacion\GitRepo\PVRA\PVRA\Models\PvraDataModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_ProductoColor]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Producto] DROP CONSTRAINT [FK_ProductoColor];
GO
...
CREATE TABLE [dbo].[InvertarioMateriales] (
    ...
    [Existencia] decimal(18,0)  NOT NULL,
    [Descripcion] varchar(255)  NULL,
    [ColorId] int  NOT NULL
);
GO
